Nodemon 
- see package.json 
- nodemon is installed as a development dependency, so if you enter the command `npm start` the server will start 
(and the webpage will refresh automatically)
